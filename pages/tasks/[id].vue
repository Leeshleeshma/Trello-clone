...
<template>
  <div class="task-wrapper">
    <div v-if="task" class="task-view">
      <UFormGroup label="Name" class="w-full mb-4 font">
        <UInput type="text" v-model="task.name" />
      </UFormGroup>
      <UFormGroup label="Labels" class="w-full mb-4 font">
        <UInput type="text" v-model="task.labels" />
      </UFormGroup>
      <UFormGroup label="Description" class="w-full mb-4 font">
